...
import com.nvpacademy.Phucacademy.Filter.JwtCookieFilter;
...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf((csrf) -> csrf.ignoringRequestMatchers("/saveMsg").ignoringRequestMatchers("/public/**")
                ...
                .ignoringRequestMatchers("/apiAuthen/**"))
                .authorizeHttpRequests((requests) -> requests.requestMatchers("/dashboard").authenticated()
                        ...
                        .requestMatchers("/api/person/public/**").permitAll()
                        .requestMatchers("/api/cart/public/**").permitAll()
                        .requestMatchers("/api/cart/auth/**").authenticated()
                        .requestMatchers("/api/regiscourse/public/**").permitAll()
                        .requestMatchers("/api/regiscourse/auth/**").authenticated()
                        .requestMatchers("/api/clupload/**").permitAll()
                        .requestMatchers("/api/payments/**").permitAll()
                        .requestMatchers("/api/contact/updatePerson/**").permitAll()
                        .requestMatchers("/api/email/public/**").permitAll()
