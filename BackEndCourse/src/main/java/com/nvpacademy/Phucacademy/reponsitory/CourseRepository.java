...
public interface CourseRepository extends JpaRepository<Courses, Integer> {
        ...
        // "AND ((:minPrice IS NULL AND :maxPrice IS NULL AND :freePrice IS NULL) OR
        // c.price = :freePrice OR (CAST(c.price AS double) >= :minPrice AND
        // CAST(c.price AS double) <= :maxPrice)) " +
        // "GROUP BY c.courseId " +
