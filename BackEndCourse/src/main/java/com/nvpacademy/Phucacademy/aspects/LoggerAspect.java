package com.nvpacademy.Phucacademy.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.nvpacademy.Phucacademy..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.nvpacademy.Phucacademy.*.*(..))", throwing = "ex")
