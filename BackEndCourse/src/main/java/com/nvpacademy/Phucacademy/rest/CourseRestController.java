...
import com.nvpacademy.Phucacademy.service.CourseService;
...
public class CourseRestController {
    ...
    @GetMapping("/public/getCourseWithAvgByTitle")
    public Object getCourseWithAvgByTitle(@RequestParam String courseTitle) {
    ...
    // Double minRatingValue = "null".equals(minRating) ? null :
    // Double.valueOf(minRating);
    // List<String> languagesList = "null".equals(languages) ? null :
    // Arrays.asList(languages.split(","));
    // List<String> categoriesList = "null".equals(categories) ? null :
    // Arrays.asList(categories.split(","));
    // List<String> levelsList = "null".equals(levels) ? null :
    // Arrays.asList(levels.split(","));
    // List<String> pricesList = "null".equals(prices) ? null :
    // Arrays.asList(prices.split(","));
    //
    // // Gọi Service với các giá trị đã được parse
    // return courseService.getAllCoursesFilter(minRatingValue, languagesList,
    // categoriesList, levelsList, pricesList, pageNumber);
    // }
    //
    //
    //
    ...
    // Double minRatingValue = "null".equalsIgnoreCase(minRating) ? null :
    // Double.valueOf(minRating);
    // List<String> languagesList = "null".equalsIgnoreCase(languages) ? null :
    // Arrays.asList(languages.split(","));
    // List<String> categoriesList = "null".equalsIgnoreCase(categories) ? null :
    // Arrays.asList(categories.split(","));
    // List<String> levelsList = "null".equalsIgnoreCase(levels) ? null :
    // Arrays.asList(levels.split(","));
    // List<String> pricesList = "null".equalsIgnoreCase(prices) ? null :
    // Arrays.asList(prices.split(","));
    //
    // return courseService.getTotalPages(minRatingValue, languagesList,
    // categoriesList, levelsList, pricesList);
    // }
    ...
    public List<Object> getCoursesByFilter(
        ...
        // Gọi Service với các giá trị đã được parse
        return courseService.getAllCoursesFilter(minRatingValue, languagesList, categoriesList, levelsList, pricesList1,
                pricesList2, pricesList3, pricesList4, pricesList5, freePrice, pageNumber);
    }
    ...
    public int getTotalPageCourses(
        ...
        return courseService.getTotalPages(minRatingValue, languagesList, categoriesList, levelsList, pricesList1,
                pricesList2, pricesList3, pricesList4, pricesList5, freePrice);
    }
