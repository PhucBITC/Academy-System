...
public class CourseService {
    ...
    // includeFree = prices.stream().anyMatch(price ->
    // price.equalsIgnoreCase("Free"));
    // if (includeFree == true){
    // freePrice = "Free";
    // }
    ...
    // Page<Object> page = courseRepository.findAllCoursesByFilter(minRating,
    // languages, categories, levels,minPrice,maxPrice,freePrice, pageable);
    ...
    // minRating, languages, categories, levels, minPrice, maxPrice, freePrice,
    // pageable);
    //
